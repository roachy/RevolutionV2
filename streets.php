...
$noturns = "Sorry, you are too exhausted. Come back when you've had a rest.";
...
$Time = mt_rand(2,30);
echo "<span style='color:red;font-weight:700;'>Unlucky!</span><br />While searching ".$cityname." you nearly got arrested.";
//$db->query(sprintf("UPDATE `users` SET `jail` = %u, `jail_reason` = 'Arrested for hanging around %s' WHERE `userid` = %u", $Time, $cityname, $userid));
}
...
$Time = mt_rand(2,50);
echo "<span style='color:red;font-weight:700;'>Unlucky!</span><br />While searching ".$cityname." nothing happened. [Placeholder for arrested]";
}
}
}
