...
<img src='http://goodcareers.files.wordpress.com/2012/03/application-photo.jpg'/>
...
print "
           <div id='mainOutput' style='text-align: center; color: green;  width: 600px; border: 1px solid #222222; height: 70px;
                        ...
                        <font color=red> Sorry but you are not qualified enough to get this job, you need:
...
$job[0] = "Corporate Office";
$job[1] = "Law Enforcement";
$job[2] = "Politics";
$job[3] = "McDaniels";
$job[4] = "Hospital";
...
if($ir['jNAME'] == $job[0]){
		print "
		<div class='generalinfo_simple'><br> <br><br>
			<img src=http://www.freeofficefinder.com/uploads/officeImages/74086/14024150848238.jpeg width=400px />
		</div>
		";
	};
...
if($ir['jNAME'] == $job[1]){
		print "
		<div class='generalinfo_simple'><br> <br><br>
			<img src=http://images.fineartamerica.com/images-medium-large-5/law-enforcement-tactical-police-gary-yost.jpg width=400  />
		</div>
		";
	};
...
if($ir['jNAME'] == $job[2]){
		print "
		<div class='generalinfo_simple'><br> <br><br>
			<img src=http://thepolitic.org/wp-content/uploads/2012/04/politics1.jpg width=400  />
		</div>
		";
	};
...
if($ir['jNAME'] == $job[3]){
		print "
		<div class='generalinfo_simple'><br> <br><br>
			<img src=http://snapabuse.com/wp-content/uploads/2013/10/fast-food.jpg width=400  />
		</div>
		";
	};
...
if($ir['jNAME'] == $job[4]){
		print "
		<div class='generalinfo_simple'><br> <br><br>
			<img src=http://www.fraunhofer.de/content/dam/zv/en/Research%20Topics/Health/hospital-engineering-laboratory/ISST13_HospitalEngineering%2003.jpg width=400  />
		</div>
		";
	};
