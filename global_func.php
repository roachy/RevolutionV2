...
// @name Get Ranks
// @purpose Get the ranks for statistics.
...
// @name Game Ranks
// @purpose Set Game ranks going off Total Points
...
if ( $tp < 100000 ) { return " Nobody"; }
else if ( $tp < 400000 ) { return " Beginner"; }
else if ( $tp < 1600000 ) { return " Novice"; }
else if ( $tp < 6400000 ) { return " Average"; }
else if ( $tp < 25600000 ) { return " Competant"; }
else if ( $tp < 102400000 ) { return " Veteran"; }
else if ( $tp < 409600000 ) { return " Distinguished"; }
else if ( $tp < 819200000 ) { return " Professional"; }
else if ( $tp < 3276800000 ) { return " Idol"; }

}

// @name Format Money
// @purpose Put comma's to seperate thousands for millions etc.
...
// @name Get Item Types
// @purpose Get all the Item Types so they can be put into a drop down menu.
...
// @name Item Dropdown
// @purpose Get all the Items so they can be put into a dropdown.
...
} // End of Function item2_dropdown
...
global $db;
	...
	$ret="<select name='$ddname' type='dropdown'>";
	$q=$db->query("SELECT * FROM cities ORDER BY cityname ASC"); // Select all from cities table order by City Name.
...
} // End of location_dropdown function
