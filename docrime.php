...
You do not have enough Action Points to perform this crime. 
...
mysql_query("UPDATE users SET money={$ir['money']}, crystals={$ir['crystals']}, exp={$ir['exp']}, crimexp=crimexp+{$r['crimeXP']}, crimes=crimes+1 WHERE userid=$userid", $c);
