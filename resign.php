<?php
/*----------------------------------------------------
-- Staff Resign Mod & Logs
-- Product Copyright (c) Jordan Palmer 2010 
-- Free for ALL Members | Mccode V2
-- Contact me @ <a href="mailto:Pudda2008@hotmail.co.uk">Pudda2008@hotmail.co.uk</a>
-----------------------------------------------------*/
...
switch($_GET['resign']) {
 ...
 print ' You are currently choosing if you wish to leave staff and go back to a member, Please be sure as there is no way to undo this action, When you click leave staff you leave ALL your powers behind, Please remember this
';
 echo '<a href="?resign=Yes" target="_blank">Resign Now</a>
 
 <a href="?resign=No" target="_blank">No, take me home</a>
';
}
function Remove()
{
...
{
print "You did not supply a reason, We need you supply one so we can make the game better
";
exit($h->endpage());
}
...
print "<h3>Resign Form</h3>
 Please supply a reason why you have resigned from staff, It could help us, And may help you.
<form action='?resign=Yes' method='post'>
Reason: <input type='text' name='Resign_Reason' value='' />
