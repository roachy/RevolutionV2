...
if($r['donatordays']) { $r['username'] = "<font color=blue>{$r['username']}</font>";$d="<img src='images/icons/heart.png' alt='Donator: {$r['donatordays']} Days Left' title='Donator: {$r['donatordays']} Days Left' />"; }
...
<div class='con_txt1'>{$r['username']}  $d  </div>
...
<div class='cap_txtpart cap_txtpart1'>
    <div class='cap_txt1 cap_txt11'>Rating:
...
<div class='cap_txtpart'>
    <div class='cap_txt1'>Busts:</div>
    <div class='cap_txt2'>{$ir['bustdone']}</div>
</div>

<div class='cap_txtpart'>
    <div class='cap_txt1'>Failed Busts:</div>
    <div class='cap_txt2'>{$ir['bustfailed']}</div>
</div>
