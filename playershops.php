...
<br>$image<br><table align=center class=table width=600><tr><td colspan=4>{$shop['description']}</td></tr>
<tr><th colspan=4>Items For Sale</th><tr>
<tr><th>Image</th><th>Item</th><th>Price Each</th><th>Option</th></tr>";
...
print"<tr><td><img src={$item['itmimg']} width=75 /></td><td>{$item['itmname']} $quantity</td><td align=center>\${$it['price']}</td><td align=center><a href=shopbuy.php?itemnum={$it['id']}>[Buy]</a></td></tr>";
}
