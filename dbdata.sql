...
INSERT INTO `settings` VALUES (NULL, 'ravanversion', '2.8.01 (Build: 2801)');
...
-- Table structure for table `shout area`  

CREATE TABLE `shoutarea` (
...
ALTER TABLE users ADD `lastShout` INT(2) NOT NULL DEFAULT 0;
ALTER TABLE users ADD `sA_Ban` VARCHAR(100) NOT NULL;
