...
<input type='radio' name='type' value='6' /> Pack 6 (20.00)<br />
...
us.IQ=us.IQ+120,u.donatordays=u.donatordays+31 WHERE u.userid={$_POST['user']}");
$d=31;
}
...
us.IQ=us.IQ+80,u.donatordays=u.donatordays+31 WHERE u.userid={$_POST['user']}");
$d=31;
}
...
{
$db->query("UPDATE users u LEFT JOIN userstats us ON u.userid=us.userid SET u.money=u.money+100000,u.crystals=u.crystals+250,
us.IQ=us.IQ+250,u.donatordays=u.donatordays+130 WHERE u.userid={$_POST['user']}");
$d=130;
} 
...
<input type='radio' name='level' value='2' /> Developer<br />
<input type='radio' name='level' value='3' /> Administrator<br />
<input type='radio' name='level' value='4' /> IRC Op<br />
<input type='radio' name='level' value='5' /> Operator<br />
