...
if($_GET['type'])
{
if(!in_array($_GET['type'], array("equip_boots")))
{
...
{
print "<h3>Equip Boots</h3><hr />
<form action='equip_boots.php' method='get'>
<input type='hidden' name='ID' value='{$_GET['ID']}' />
Click Equip Boots to equip {$r['itmname']} as your boots, if you currently have any boots equipped it will be removed back to your inventory.
 
<input type='hidden' name='type' value='equip_boots'  />
<input type='submit' value='Equip Boots' /></form>";
}
$h->endpage();
?>