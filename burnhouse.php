...
function index()
{
    ...
    $cost = money_formatter(($r['level'] * 10000), '');
...
<div class='generalinfo_simple'><br> <br><br>
        ...
        Would you like to burn down {$r['username']}'s home for \$$cost? <br /> <br />
        ...
        <input type = 'submit' STYLE='color: black;  background-color: green;' value = 'No' /> </form></div><div><img src='images/generalinfo_btm.jpg' alt='' /></div><br></div></div></div></div></div>";
    }
}
...
function pour_petrol()
{
    ...
    if($_GET['ID'] == $userid)
    {
          die("Why are you trying to burn your own house down?");
    }
    ...
    if($ir['money'] < $cost)
    {
        die("You don't have enough money to burn down {$r['username']}'s house. It costs $$cost,  <a href = 'bank.php' />Go Here</a> to get some more.");
    }
