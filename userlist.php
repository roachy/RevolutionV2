...
{
$d="";
if($r['donatordays']) {$d="<span><img src='images/icons/heart.png' alt='Donator: {$r['donatordays']} Days Left' title='Donator: {$r['donatordays']} Days Left' /></span>"; $r['username'] = "<font color=blue>{$r['username']}</font>"; }
