...
{
print "<tr><td><a href='viewuser.php?u=".$r.">".$r['username']." [".number_format($r['userid'])."]</a></td> <td>".htmlentities(stripslashes($r['reason']))."</td> <td>".date('F j Y g:i:s a', $r['time'])."</td> <td>".$r['ip']."</td></tr>";
}
print "</table>
