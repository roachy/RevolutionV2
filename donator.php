...
<li>30 days Donator Status: Blue name + heart next to your name</li>
...
<li><b>NEW!</b> Gain Action points twice as quick</li></ul><br />
...
<li>55 days Donator Status: Blue name + heart next to your name</li>
<li><b>NEW!</b> Friend and Black Lists</li>
<li><b>NEW!</b> 17% Energy every 5 mins instead of 8%</li></ul>
<li><b>NEW!</b> Gain HP twice as quick</li></ul>
<li><b>NEW!</b> Gain Will twice as quick</li></ul>
...
<li><b> NEW </b> Free Golden M1911 which is twice as powerful as the original!</li>
<li>115 days Donator Status: Blue name + heart next to your name</li>
<li><b>NEW!</b> Friend and Black Lists</li>
<li><b>NEW!</b> 17% Energy every 5 mins instead of 8%</li></ul>
<li><b>NEW!</b> Gain HP twice as quick</li></ul>
<li><b>NEW!</b> Gain Will twice as quick</li></ul>
...
<h1> New Donator Pack! </h1>
<b>Golden Pack ($20.00 pack):</b><ul>
<li>\$100,000 game money</li>
<li>250 crystals</li>
<li>250 IQ, the hardest stat to get in the game!</li>
<li><b> NEW </b>A free Golden M1911 valued which is twice as powerful as the original!</li>
<li><b> NEW </b>A free Golden Tommy Gun which is twice as powerful as the original!</li>
<li>125 days Donator Status: Blue name + heart next to your name</li>
<li>Friend and Black Lists</li>
<li>17% Energy every 5 mins instead of 8%</li></ul>
<li>Gain HP twice as quick</li></ul>
<li>Gain Will twice as quick</li></ul>
<li>Gain Action Points twice as quick</li></ul><br />
<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
<input type="hidden" name="cmd" value="_xclick">
<input type="hidden" name="business" value="{$set['paypal']}">
<input type="hidden" name="item_name" value="{$domain}|DP|5|{$userid}">
...
<input type="hidden" name="no_shipping" value="1">
<input type="hidden" name="return" value="http://{$domain}/donatordone.php?action=done&type=goldpack">
<input type="hidden" name="cancel_return" value="http://{$domain}/donatordone.php?action=cancel">
<input type="hidden" name="notify_url" value="http://{$domain}/ipn_donator.php">
<input type="hidden" name="cn" value="Your Player ID">
<input type="hidden" name="currency_code" value="USD">
...
<p> All donations are final, refunds will not be given. If you have a problem with your donator perks, please contact a member of staff and they will fix your problem. </p>
EOF;
$h->endpage();
?>
